(defproject om-time "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              {:app
               {:source-paths ["src/cljs"]
                ...
                :compiler {:main om-time.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/om_time.js"
